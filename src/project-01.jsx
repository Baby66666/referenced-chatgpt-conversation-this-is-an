...
function ProjectPage() {
  ...
  return <main className="project-page">
    <div className="project-opening-wipe" aria-hidden="true"><span>PROJECT 01<br />ACTIVITY UI DESIGN</span></div>
    ...
    <section className="project-showcase" id="project-showcase">
      <div className="shell project-showcase-intro"><div><p className="section-label">( PROJECT 01 ) / ACTIVITY UI DESIGN</p><h1><span>中东活动</span><em>视觉设计</em></h1></div><div className="project-showcase-meta"><span>2025 — 2026</span><p>活动视觉、Banner、UI 界面与延展物料。</p><a href="/#contact">CONTACT <b>↗</b></a></div></div>
      ...
      <div className="shell project-showcase-end"><span className="project-end-rule" aria-hidden="true" /><span className="project-end-label">END OF PROJECT 01</span><a href="/#work">BACK TO SELECTED WORK ↑</a></div>
    </section>
  </main>
}
